...
"""Muscle meshes from stature, sex and athleticism.
...
def muscle_mesh(
    ...
    """Return one named muscle sized for `spec`.
    ...
    """
    return muscle_from_dimensions(muscle_dimensions(spec, side), part, detail)


def muscle_from_dimensions(
    dimensions: MuscleDimensions, part: MusclePart, detail: Int = 16
) raises -> BufferGeometry:
