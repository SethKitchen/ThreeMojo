...
`extensions/` is that split. The first path is `humanoid/skeleton/leg/`. A later bone lands next to the femur, tibia, fibula and patella. The knee tissues sit in `leg/knee/`. The named muscles sit in `leg/muscles/`. Vessels, lymph, nerves, skin and hair sit beside them.

Grass, terrain and water each get their own folder under `extensions/`.
