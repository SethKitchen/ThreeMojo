...
A six foot male at a 5 mm step has about 72 g of bone tissue. That is 0.70 N, or 0.16 lbf, on Earth. The value is a grid-sampled estimate under the template tissues. It is not a proven upper bound. A thin shaft needs a finer step than a femur for a stable left and right comparison.
